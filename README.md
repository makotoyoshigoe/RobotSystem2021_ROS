# translate
テキストボックスに日本語の文章を入力して翻訳ボタンを押すと, いくつかの言語で翻訳された文章が表示されます. また, 再生ボタンを押すことで, その言語で文章を読んだ音声が再生されます. 
...
ROSのインストールからワークスペースの作成は, [ryuichiueda](https://github.com/ryuichiueda)様が作成された[こちら](https://www.youtube.com/watch?v=PL85Pw_zQH0)の動画を参考に行いました. 
#### 使用するモジュールのインストール
